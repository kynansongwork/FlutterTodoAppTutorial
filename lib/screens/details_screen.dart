    ...
    return BlocBuilder<TodosBloc, TodosState>(
      builder: (context, state) {
        final todo = (state as TodosLoadSuccess)
          ...
          // An id is needed to pull the todo details from the Todo bloc to allow
          // for updates.
          
        final localisations = ArchSampleLocalizations.of(context);
        return Scaffold(
          appBar: AppBar(
            title: Text(localisations.todoDetails),
            actions:[
              IconButton(
                tooltip: localisations.deleteTodo,
          ...
          body: todo == null 
            ...
            floatingActionButton: FloatingActionButton(
              ...
              tooltip: localisations.editTodo,
